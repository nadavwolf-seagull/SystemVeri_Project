...
## The BUFGCTRL forwards only one clock at a time.
#set mux_i0 [get_pins \
...
#    -group [get_clocks clk_selected_100] \
#    -group [get_clocks clk_selected_130]


## Intentional clock-mux control crossing
#set_false_path \
#    -from [get_cells u_lab12_clock_wrapper/pll_locked_sync_reg] \
#    -to [get_pins u_lab12_clock_wrapper/u_glitchless_clk_mux/u_bufgmux/CE1]
